...
function buildOperationEnv(
  ...
  if (kind === 'export-live' || kind === 'export-live-resume') {
    if (kind === 'export-live-resume') env.DEEPVAULT_EXPORT_LIVE_RESUME = '1'
    if (extraEnv.DEEPVAULT_ENTRA_AUTH_MODE) env.DEEPVAULT_ENTRA_AUTH_MODE = extraEnv.DEEPVAULT_ENTRA_AUTH_MODE
    if (extraEnv.DEEPVAULT_ENTRA_BASE_URL) env.DEEPVAULT_ENTRA_BASE_URL = extraEnv.DEEPVAULT_ENTRA_BASE_URL
    if (extraEnv.DEEPVAULT_ENTRA_TIMEOUT_SECONDS) env.DEEPVAULT_ENTRA_TIMEOUT_SECONDS = extraEnv.DEEPVAULT_ENTRA_TIMEOUT_SECONDS
    if (extraEnv.DEEPVAULT_ENTRA_SCOPES) env.DEEPVAULT_ENTRA_SCOPES = extraEnv.DEEPVAULT_ENTRA_SCOPES
