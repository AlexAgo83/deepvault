...
# Plan
- [ ] 1. Freeze the non-V2 source set and confirm the exact request, backlog, and task coverage to be orchestrated.
- [ ] 2. Execute Wave 1 first and keep it limited to the local companion, ingestion, sync, retrieval, and evaluation baseline.
- [ ] 3. Execute Wave 2 next and keep it limited to the shell, explorer, runtime, and UI surface work.
