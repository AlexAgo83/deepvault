...
```mermaid
%% logics-kind: backlog
%% logics-signature: backlog|explorer-badge-and-source-line-polish|req-006-explorer-card-hierarchy-and-visu|make-the-explorer-cards-feel-more|ac1-explorer-cards-feel-more-polished
flowchart TD
    Request[req_006_explorer_card_hierarchy_and_visual] --> Problem[Make the explorer cards feel more]
    Problem --> Scope[Explorer badge and source line polish]
