## item_035_compact_title_row_spacing_and_regression_checks - Compact title row spacing and regression checks
> From version: 1.0.0
> Schema version: 1.0
> Status: Ready
> Understanding: 78%
...
```mermaid
%% logics-kind: backlog
%% logics-signature: backlog|compact-title-row-spacing-and-regression|req-009-explorer-file-type-pill-inline-w|keep-the-file-type-visible-as|ac1-the-explorer-card-title-row
flowchart TD
