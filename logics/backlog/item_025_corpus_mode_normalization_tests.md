...
```mermaid
%% logics-kind: backlog
%% logics-signature: backlog|corpus-mode-normalization-tests|req-005-coverage-uplift-for-corpus-mode-|add-focused-tests-for-src-lib|ac1-corpus-mode-normalization-and-fallba
flowchart TD
    Request[req_005_coverage_uplift_for_corpus_mode_li] --> Problem[Add focused tests for src lib]
    Problem --> Scope[Corpus mode normalization tests]
