...
```mermaid
%% logics-kind: backlog
%% logics-signature: backlog|use-native-sharepoint-file-weburl|req-010-fix-sharepoint-file-links-in-exp|open-sharepoint-files-from-explorer-with|ac1-clicking-a-file-from-explorer
flowchart TD
    Request[req_010_fix_sharepoint_file_links_in_explo] --> Problem[Open SharePoint files from Explorer with]
    Problem --> Scope[Use native SharePoint file webUrl]
