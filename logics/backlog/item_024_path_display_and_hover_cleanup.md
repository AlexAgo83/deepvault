...
```mermaid
%% logics-kind: backlog
%% logics-signature: backlog|path-display-and-hover-cleanup|req-004-nexus-v1-1-remaining-polish-and-|remove-the-last-pieces-of-internal-works|ac1-the-shell-no-longer-feels
flowchart TD
    Request[req_004_nexus_v1_1_remaining_polish_and_bi] --> Problem[Remove the last pieces of internal-workspa]
    Problem --> Scope[Path display and hover cleanup]
